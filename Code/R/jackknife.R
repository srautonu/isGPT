...
for (maxFeatureCount in seq(from=nFeatures, to=2000, by=-50)){
...
cat("For Features Numbers:", nFeatures,"\n");
...
saveRDS(preddata,"jackknifetestpredictionsdatasmote.rds")
saveRDS(bestjnmodel, "bestjackknifemodelsmote.rds")
